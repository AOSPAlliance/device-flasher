...
func preparation(logger *logrus.Logger, step int) {
	...
	case 2:
		...
		screenshot = &canvas.Image{Resource: resources.ResourceSettingsPanelSvg, FillMode: canvas.ImageFillContain}
	case 3:
		...
		screenshot = &canvas.Image{Resource: resources.ResourceDeveloperModeSvg, FillMode: canvas.ImageFillContain}
	case 4:
		...
		screenshot = &canvas.Image{Resource: resources.ResourceOEMUnlockingSvg, FillMode: canvas.ImageFillContain}
	case 5:
		...
		screenshot = &canvas.Image{Resource: resources.ResourceEnableUSBDebuggingSvg, FillMode: canvas.ImageFillContain}
	case 6:
		...
		screenshot = &canvas.Image{Resource: resources.ResourceUSBDebuggingSvg, FillMode: canvas.ImageFillContain}
...
func (textGridWriter *scrollableTextGridWriter) Write(p []byte) (n int, err error) {
	...
	if strings.Contains(line, "Please") {
		...
		//	screenshot = &canvas.Image{Resource: resources.ResourceOEMLockSvg, FillMode: canvas.ImageFillContain}
		//} else {
		//	screenshot = &canvas.Image{Resource: resources.ResourceOEMUnlockingSvg, FillMode: canvas.ImageFillContain}
		//}
		//screenshot.SetMinSize(fyne.Size{
